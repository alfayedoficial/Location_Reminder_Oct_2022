package com.alialfayed.locationreminder.ui.reminderDescription.view
...
import com.alialfayed.locationreminder.databinding.ActivityOneSingleBinding
import com.alialfayed.locationreminder.databinding.ActivityReminderDescriptionBinding
...
class ReminderDescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (intent.getSerializableExtra(AppConstant.EXTRA_ReminderDataItem) as? ReminderEntity?)?.let {
