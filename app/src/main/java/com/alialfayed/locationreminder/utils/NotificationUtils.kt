...
import com.alialfayed.locationreminder.BuildConfig
...
import com.alialfayed.locationreminder.utils.AppConstant.NOTIFICATION_CHANNEL_ID
...
fun sendNotificationUtils(context: Context, reminderDataItem: ReminderEntity) {
    ...
    val intent = newIntent(context.applicationContext, reminderDataItem)
